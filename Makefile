...
#LABELLER_VERSION represents version of kubevirt-node-labeller (https://github.com/ksimon1/kubevirt-node-labeller)
#CPU_PLUGIN_VERSION represents version of kubevirt-cpu-nfd-plugin (https://github.com/ksimon1/kubevirt-cpu-nfd-plugin)
